  ...
  return (
    <div className="height-dvh px-8 font-[poppins]">
      <div className="mx-auto max-w-[800px] space-y-8 pt-18">
        ...
        <button onClick={() => navigate('/')} className="mx-auto block cursor-pointer rounded-full border border-zinc-300 bg-zinc-100 px-6 py-2 text-sm font-medium transition-[color,background-color,box-shadow] dark:border-zinc-700 dark:bg-zinc-800 [@media(pointer:fine)]:hover:bg-zinc-200 [@media(pointer:fine)]:hover:shadow-md dark:[@media(pointer:fine)]:hover:bg-zinc-700">
          Go Home
        </button>
      </div>
    </div>
