...
function EachNote({ note, func }) {
  ...
  return (
    <motion.div
      ...
      className="group relative grid max-w-[810px] grid-rows-[23px_1fr] gap-2 overflow-hidden rounded-lg border border-zinc-200 p-4 text-zinc-700 transition-[box-shadow,color,background-color,border-color] duration-150 select-none hover:text-zinc-950 hover:shadow-md hover:shadow-zinc-200 dark:border-zinc-800 dark:text-zinc-300 dark:hover:text-zinc-50 dark:hover:shadow-zinc-800"
    >
